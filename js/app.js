(() => {
    ...
    (() => {
        ...
        da.init();
        let searchIcon = document.querySelector(".menu__form-btn");
        let searchMenu = document.querySelector(".form");
        searchIcon.addEventListener("click", (function(e) {
            searchMenu.classList.toggle("_active");
        }));
        document.addEventListener("click", (function(e) {
            if (!e.target.closest(".header__menu")) searchMenu.classList.remove("_active");
        }));
        let btnOne = document.getElementById("btn_one");
        let spanOne = document.getElementById("span_one");
        let btnTwo = document.getElementById("btn_two");
        let spanTwo = document.getElementById("span_two");
        let btnThree = document.getElementById("btn_three");
        let spanThree = document.getElementById("span_three");
        btnOne.addEventListener("click", changeTextOne);
        btnTwo.addEventListener("click", changeTextTwo);
        btnThree.addEventListener("click", changeTextThree);
        function changeTextOne(event) {
            let subed = spanOne;
            if (subed) toggleTextOne(subed);
        }
        function changeTextTwo(event) {
            let subed = spanTwo;
            if (subed) toggleTextTwo(subed);
        }
        function changeTextThree(event) {
            let subed = spanThree;
            if (subed) toggleTextThree(subed);
        }
        function toggleTextOne(button) {
            if ("Подписаться" == button.innerHTML) {
                button.innerHTML = "Отписаться";
                btnOne.classList.toggle("_active");
            } else if ("Отписаться" == button.innerHTML) {
                button.innerHTML = "Подписаться";
                btnOne.classList.remove("_active");
            } else null;
        }
        function toggleTextTwo(button) {
            if ("Подписаться" == button.innerHTML) {
                button.innerHTML = "Отписаться";
                btnTwo.classList.toggle("_active");
            } else if ("Отписаться" == button.innerHTML) {
                button.innerHTML = "Подписаться";
                btnTwo.classList.remove("_active");
            } else null;
        }
        function toggleTextThree(button) {
            if ("Подписаться" == button.innerHTML) {
                button.innerHTML = "Отписаться";
                btnThree.classList.toggle("_active");
            } else if ("Отписаться" == button.innerHTML) {
                button.innerHTML = "Подписаться";
                btnThree.classList.remove("_active");
            } else null;
        }
        window["FLS"] = false;
        isWebp();
